...
//    options.disable_function_signatures();
    ...
    py::class_<VoIPController, PyVoIPController>(m, "VoIPController")
            ...
            .def("_init", &VoIPController::init, py::call_guard<py::gil_scoped_release>())
            .def("start", &VoIPController::start,  py::call_guard<py::gil_scoped_release>())
            .def("connect", &VoIPController::connect,  py::call_guard<py::gil_scoped_release>())
            .def("set_proxy", &VoIPController::set_proxy,  py::call_guard<py::gil_scoped_release>())
            .def("set_encryption_key", &VoIPController::set_encryption_key,  py::call_guard<py::gil_scoped_release>())
            .def("set_remote_endpoints", &VoIPController::set_remote_endpoints,  py::call_guard<py::gil_scoped_release>())
            .def("get_debug_string", &VoIPController::get_debug_string,  py::call_guard<py::gil_scoped_release>())
            .def("set_network_type", &VoIPController::set_network_type,  py::call_guard<py::gil_scoped_release>())
            .def("set_mic_mute", &VoIPController::set_mic_mute,  py::call_guard<py::gil_scoped_release>())
            .def("set_config", &VoIPController::set_config,  py::call_guard<py::gil_scoped_release>())
            .def("debug_ctl", &VoIPController::debug_ctl,  py::call_guard<py::gil_scoped_release>())
            .def("get_preferred_relay_id", &VoIPController::get_preferred_relay_id,  py::call_guard<py::gil_scoped_release>())
            .def("get_last_error", &VoIPController::get_last_error, py::call_guard<py::gil_scoped_release>())
            .def("get_stats", &VoIPController::get_stats, py::call_guard<py::gil_scoped_release>())
            .def("get_debug_log", &VoIPController::get_debug_log, py::call_guard<py::gil_scoped_release>())
            .def("set_audio_output_gain_control_enabled", &VoIPController::set_audio_output_gain_control_enabled, py::call_guard<py::gil_scoped_release>())
            .def("set_echo_cancellation_strength", &VoIPController::set_echo_cancellation_strength, py::call_guard<py::gil_scoped_release>())
            .def("get_peer_capabilities", &VoIPController::get_peer_capabilities, py::call_guard<py::gil_scoped_release>())
            .def("need_rate", &VoIPController::need_rate,  py::call_guard<py::gil_scoped_release>())
            ...
            .def("_native_io_get", &VoIPController::_native_io_get,  py::call_guard<py::gil_scoped_release>())
            .def("_native_io_set", &VoIPController::_native_io_set,  py::call_guard<py::gil_scoped_release>())
            .def("play", &VoIPController::play,  py::call_guard<py::gil_scoped_release>())
            .def("play_on_hold", &VoIPController::play_on_hold,  py::call_guard<py::gil_scoped_release>())
            .def("set_output_file", &VoIPController::set_output_file,  py::call_guard<py::gil_scoped_release>())
            .def("clear_play_queue", &VoIPController::clear_play_queue,  py::call_guard<py::gil_scoped_release>())
            .def("clear_hold_queue", &VoIPController::clear_hold_queue,  py::call_guard<py::gil_scoped_release>())
            .def("unset_output_file", &VoIPController::unset_output_file,  py::call_guard<py::gil_scoped_release>())
